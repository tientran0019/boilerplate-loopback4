...
* Phone 0972970075
*
* Created: 2023-10-08 16:54:59

* Last updated on: 2023-10-08 16:54:59
* Last updated by: Tien Tran
*------------------------------------------------------- */

// HOW TO USE
// adding into the src/application.ts file
/*
...
export class ValidationErrorMiddlewareProvider implements Provider<Middleware> {
	...
	/**
	 * Handle errors
	 * If the request url is `/test-middleware`, customize the error message.
	 * @param context
	 * @param err
	 */
	handleError(
		...
		if (context.request.url === '/test-middleware') {
